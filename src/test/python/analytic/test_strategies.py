...
class TestStrategies(unittest.TestCase):
    ...
    def rtn_compare_pic(avoid_slump_run: AvoidSlump, date, ax):
        first_open = avoid_slump_run.hist_data[date][avoid_slump_run.col_dict['open']].iloc[0]
        first_close = avoid_slump_run.hist_data[date][avoid_slump_run.col_dict['close']].iloc[0]

        closes = avoid_slump_run.hist_data[date][avoid_slump_run.col_dict['close']]
        closes_rtn = closes / first_open
        closes_rtn.name = 'closes_rtn'
        totals = avoid_slump_run.totals
        totals_rtn = totals / (totals.iloc[0] * first_open / first_close)
    ...
    def test_save_figs(self):
        ...
        selected_dates = ['2017-10-02', '2017-06-27', '2017-09-18', '2017-11-20', '2017-09-27',  '2017-11-02', '2017-07-07', '2017-12-08', '2017-12-07', '2017-10-26',  '2017-09-29', '2017-12-18', '2017-12-19', '2017-07-17', '2017-07-06',  '2017-12-15', '2017-11-06', '2017-10-11', '2017-10-09', '2017-08-14',  '2017-12-28', '2017-08-04', '2017-09-07', '2017-06-13', '2017-08-11',  '2017-07-19', '2017-07-03', '2017-08-08', '2017-06-22', '2017-08-01',  '2017-08-28', '2017-10-16', '2017-11-15', '2017-08-22', '2018-01-02',  '2017-09-11', '2017-12-13', '2017-08-07', '2017-11-08', '2017-11-21',  '2017-06-21', '2017-09-15', '2017-08-21', '2017-08-30', '2017-10-03',  '2017-11-10', '2017-12-29', '2017-10-31', '2017-07-14', '2017-06-28',  '2017-10-13', '2017-11-27', '2017-06-19', '2017-09-21', '2017-06-05',  '2017-06-07', '2017-08-25', '2017-11-24', '2017-10-06', '2017-11-30',  '2017-06-29', '2017-07-13', '2017-09-13', '2017-08-17', '2017-07-21',  '2017-11-13', '2017-12-06', '2017-10-20', '2017-08-23', '2017-09-12',  '2017-08-15', '2017-11-14', '2017-06-23', '2017-10-19', '2017-11-28',  '2017-09-22', '2017-06-06', '2017-11-07', '2017-09-26', '2017-07-26',  '2017-09-01', '2018-01-03', '2017-08-29', '2017-08-31', '2017-09-08',  '2017-07-10', '2017-05-26', '2017-12-12', '2017-06-02', '2017-06-08',  '2017-06-16', '2017-08-03', '2017-11-03', '2017-06-15', '2017-10-10',  '2017-11-16', '2017-10-05', '2017-06-01', '2017-06-12', '2017-10-23',  '2017-05-31', '2017-10-17', '2017-10-30', '2017-09-06', '2018-01-04',  '2017-09-19', '2017-07-24', '2017-09-14', '2017-07-05', '2017-10-27',  '2017-10-04', '2017-12-22', '2017-07-20', '2017-09-20', '2017-12-14',  '2017-05-30', '2017-07-11', '2017-08-24', '2017-12-26', '2017-07-18',  '2017-08-09', '2017-07-28', '2017-09-28', '2017-12-11', '2017-10-12',  '2017-09-05', '2018-01-05', '2017-10-24', '2017-06-20', '2017-07-25',  '2017-12-27', '2017-08-16', '2017-10-18', '2017-07-12', '2017-12-20',  '2017-09-25', '2017-11-01', '2017-10-25', '2017-08-10', '2017-06-14',  '2017-12-01', '2017-06-30', '2017-11-22', '2017-07-31', '2017-11-09',  '2017-12-04', '2017-08-18', '2017-06-09', '2017-12-21', '2017-08-02',  '2017-07-27', '2017-12-05', '2017-11-17', '2017-06-26', '2017-11-29',  '2017-05-29', '2017-07-04', '2017-09-04', '2017-11-23', '2017-12-25',  '2018-01-01']
    ...
    def test_avoid_slump(self):
        ...
        for z_threshold in np.arange(-1.0, -0.9, 0.1):
            ...
            if output_daily_return_pic:
                ...
                ax=daily_bnh.plot(title="STRATEGY VS BUY AND HOLD", legend=True)
                daily_last.plot(ax=ax, legend=True)
                plt.show()
